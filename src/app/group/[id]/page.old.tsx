...
export default async function Page({
	...
	const expenses : ExpenseDto[]= await fetch(`http://127.0.0.1:3001/api/expenses/group/${id}`).then((res) => res.json())
	const settlements : SettlementDto[]= await fetch(`http://127.0.0.1:3001/api/settlements/group/${id}`).then((res) => res.json())
	console.log(expenses, settlements)
	return <div>
